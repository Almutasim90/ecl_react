    ...
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.textSecondary, fontFamily: 'Poppins_600SemiBold' }]}>
            {t('general')}
          </Text>
          ...
          >
            <Text style={[styles.optionText, { color: colors.text, fontFamily: 'Poppins_600SemiBold' }]}>
              {t('language')}
            </Text>
            <Text style={[styles.optionValue, { color: colors.textSecondary, fontFamily: 'Poppins_600SemiBold' }]}>
              English
            </Text>
          </TouchableOpacity>
