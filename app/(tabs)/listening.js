...
import { fetchListeningQuestions, getFormList, fetchQuizProgress } from '../../lib/api';
...
export default function ListeningScreen() {
  ...
  const handleFormPress = (formNumber, questions) => {
    ...
    if (saved) {
      ...
      startQuiz({ type: 'listening', formNumber, questions, currentIndex: resumeIndex, answers: saved.answers });
    } else {
